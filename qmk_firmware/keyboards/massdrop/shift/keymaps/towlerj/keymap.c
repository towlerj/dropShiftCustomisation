...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        KC_TILD, _______,  C(KC_W),  _______,  C(KC_R),  C(KC_T),  _______,  _______,  U_T_AGCR, _______,  _______,  _______, _______, _______,    KC_MPRV, KC_MNXT, KC_VOLD, KC_SLCK, \
    ...
    [2] = LAYOUT(
        ...
        _______, _______, _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,                      KC_P1,   KC_P2,   KC_P3,            \
                                                                                                                             _______,                                         KC_PENT, \
        _______, _______, _______,                   _______,                            _______, _______,                                                  KC_P0,   KC_DOT,          \
...
led_instruction_t led_instructions[] = {
    ...
    */
    ...
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB, .id0 = 4294967295, .id1 = 4294967295, .id2 = 4294967295,.id3 = 4294967232, .id4 = 4294967295, .id5 = 4080,  .r = 255, .g = 0,   .b = 0,   .layer = 2 },
